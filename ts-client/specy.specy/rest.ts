 ...
 */
export type SpecyParams = object;
...
/**
 * @title specy/specy/executor.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/specy/specy/executor
   */
  queryExecutorAll = (
    query?: {
   ...
   * @tags Query
   * @name QueryExecutor
   * @summary Queries a Executor by index.
   * @request GET:/specy/specy/executor/{address}
   */
  queryExecutor = (address: string, params: RequestParams = {}) =>
    this.request<SpecyQueryGetExecutorResponse, RpcStatus>({
      path: `/specy/specy/executor/${address}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/specy/specy/params
   */
