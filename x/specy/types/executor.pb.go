...
type Executor struct {
	...
	ValAddr              string `protobuf:"bytes,4,opt,name=valAddr,proto3" json:"valAddr,omitempty"`
}
...
func (m *Executor) GetValAddr() string {
	if m != nil {
		return m.ValAddr
	}
	return ""
...
var fileDescriptor_39e9689693a618cc = []byte{
	...
	,
}
...
func (m *Executor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValAddr) > 0 {
		...
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.ValAddr)))
		i--
		dAtA[i] = 0x22
	}
