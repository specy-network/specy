...
```bash
osmosisd keys list --home data/osmosis-testnet-5 --keyring-backend test
```
...
export WALLET_3=$(osmosisd keys show rly2 -a --keyring-backend test --home ./data/osmosis-testnet-5) && echo $WALLET_3;
```
...
osmosisd tx bank send $WALLET_3 $ICA_ADDR 10osmo --chain-id osmosis-testnet-5 --home ./data/osmosis-testnet-5 --node http://222.106.187.14:53402 \
